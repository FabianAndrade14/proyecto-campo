...
<body class="bg-gradient-primary" style="background-image: url('img/background.jpg');">
            ...
            <div class="row">
              ...
              <div class="col-lg-6">
                <div class="p-5"> 
                  ...
                  <form class="user" action="Logic/login.php" method="POST">
                    <div class="form-group">
                      <input type="text" class="form-control form-control-user"   placeholder="Usuario" name="username">
                    </div>
                    <div class="form-group">
